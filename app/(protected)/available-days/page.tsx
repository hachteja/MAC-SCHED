...
export default async function AvailableDaysPage({
  ...
  const projectBookingRows = (((allProjectBookings as unknown) as BookingRow[] | null) ?? [])
  ...
  const dayRows = ((((days as unknown) as CalendarRow[] | null) ?? [])).filter((d) => d.day >= todayStr)
  ...
  const bookingRows = (((allBookings as unknown) as BookingRow[] | null) ?? [])
